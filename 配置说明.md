...
**文件位置**: `distribute_options.yaml` (项目根目录)
...
**说明**: 
- 这是 Flutter Distributor 的构建配置
- `app_name` 决定构建输出的应用名称
- 影响安装包的默认目录名称
...
- `install_dir_name`: 安装目录名称（`{autopf}` 代表 Program Files）
