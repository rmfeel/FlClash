...
- feat: 完善配置文件安全管理 - 菜单改节点/禁止第三方配置/登录检测清理/自动导入优化

## v1.0.8

- 完善退出登录功能：自动关闭VPN并清除订阅配置文件
...
- 修复Android构建：签名和Google Services配置变为可选

## v1.0.1

- 修复子模块URL为HTTPS，使用原版chen08209的fork
